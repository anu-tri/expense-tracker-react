    ...
    render() {
        ...
        return (
            ...
            <div  style={styles.pageStyles}>
                ...
                <p style={{marginTop:"-100px"}}>Steps to analyze your expenditure</p>
                    <span style={{width:"150px", display:"inline-block", height:"50px" , fontSize:"15px", color:"white", backgroundColor:"#00b359", paddingTop:"12px", paddingLeft:"18px"}}>
                        Add Budget
                    </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span style={{width:"130px", display:"inline-block", height:"50px" , fontSize:"15px", color:"white", backgroundColor:"#ffcc00", paddingTop:"12px", paddingLeft:"18px"}}>
                        Add Expense
                    </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span style={{width:"130px", display:"inline-block", height:"50px" , fontSize:"15px", color:"white", backgroundColor:"#9933ff", paddingTop:"12px", paddingLeft:"18px"}}>
                        View Reports
                    </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </div><br/><br/> */}
              </div>  
